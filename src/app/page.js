...
export default function Home() {
  ...
  return (
    <>
      ...
      <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl ml-10 my-5"><span className ="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Raise Funds</span> for a noble cause.</h1>
      <p className="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400 ml-20">We are raising funds to help the needy and less fortunate.</p>
